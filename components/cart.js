    ...
    <div>
      <Badge style={{ width: 200, padding: 10 }} color="light">
        ...
        <h3>${cart.total}</h3>
          ...
          <Link href="/checkout/">
            <Button style={{ width: "70%" }} color="danger">
              <a>Order</a>
            </Button>
          </Link>
    </div>
...
// return Cart
  return (
    <div style={{marginBottom: "3rem"}}>
      <h1 style={{fontFamily: "'Roboto', sans-serif", paddingTop: '2rem', color: "#eeeeee", fontWeight: '200', fontSize: '2rem'}} > Cart</h1>
      <Card style={{ padding: "10px 5px", marginBottom: "2rem"}}>
